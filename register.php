        ...
        <div class="form-box">
                ...
                <form action="functions/authcode.php" method="POST">
                    <div class="two-forms">
                        ...
                        <div class="input-box">
                            <input type="password" class="form-control pl-5" required name="password" placeholder="Parola">
                            <i class="fas fa-lock mt-2" style="color:#192655" ></i>
                        </div>
                        <div class="input-box">
                            <input type="password" class="form-control pl-5" required name="cpassword" placeholder="Confirma parola">
                            <i class="fas fa-lock mt-2" style="color:#192655" ></i>
                        </div>
                        <div class="input-box">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                <h4>Contact</h4>
                <p><strong>Adresa(strada,numar,oras,judet): </strong> 2201 Hotel Cir S, San Diego, CA 92108</p>
