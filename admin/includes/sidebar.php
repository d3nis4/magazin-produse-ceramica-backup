      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="index.php"?'active bg-gradient-primary':'';  ?> " href="index.php">
            ...
            <span class="nav-link-text ms-1">Prima Pagina</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="category.php"?'active bg-gradient-primary':'';  ?>  " href="category.php">
            ...
            <span class="nav-link-text ms-1">Toate categoriile</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="add-category.php"?'active bg-gradient-primary':'';  ?> " href="add-category.php">
            ...
            <span class="nav-link-text ms-1">Adaugă Categorie</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="add-product.php"?'active bg-gradient-primary':'';  ?> " href="add-product.php">
            ...
            <span class="nav-link-text ms-1">Adaugă produs</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="add-cupon.php"?'active bg-gradient-primary':'';  ?> " href="add-cupon.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-plus opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Adaugă cupon </span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="cupon.php"?'active bg-gradient-primary':'';  ?>  " href="cupon.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
            <span class="nav-link-text ms-1">Toate cupoanele</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white <?= $page=="cupon.php"?'active bg-gradient-primary':'';  ?>  " href="cupon.php">
            ...
            <span class="nav-link-text ms-1">Site in mentenanta</span>
          </a>
        </li>
